...
import { MButton, MInput, MCheckbox, MAlert } from "components/CustomMaterial"
...
const Signup = () => {
  ...
  const handleSignup = () => {
    ...
    validation_str.push(
      validator(password, ["require", "confirm_password"], confirmPassword)
    )
            ...
            <Box sx={{ maxWidth: "500px", width: "100%", my: 4 }}>
              <Container>
                <Box sx={{ mb: 2 }}>
                  <Typography
                    variant="subTitle3"
                    sx={{ color: "#141414", fontWeight: 500 }}
                  >
                    Sign up to Video Browsing System
                  </Typography>
                </Box>
                <MInput
                  label="First Name"
                ...
                <FormControlLabel
                  ...
                  label={
                    <Typography variant="subTitle" sx={{ color: "#858585" }}>
                      I accept{" "}
                      <Link href="/terms" target="_blank" color="#000">
                        terms
                      </Link>{" "}
                      and{" "}
                      <Link href="/terms" target="_blank" color="#000">
        ...
        <Hidden mdDown>
          <Grid item md={6} sx={{ backgroundColor: "#F6F8FE" }}>
            <Stack
              justifyContent="center"
              alignItems="center"
              sx={{ position: "sticky", top: "calc((100vh - 550px) / 2 )" }}
            >
              <Card
                sx={{
                  mb: 3,
